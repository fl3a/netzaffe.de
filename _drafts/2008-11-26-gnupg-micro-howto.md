...
Nach Angabe aller Daten werden diese nochmal ausgegeben, es besteht die Möglichkeit die einzelnen Werte zu korregieren.
...
Erstellung des GNUPG Revoke-Keys
...
## Nützliche Software für die Benutzung von GnuPG Nutzung

Diverse nützliche Software für die Nutzung von GnuPG unter Windows, Mac OS, die Integration in Mail-Clients, Datei Browser oder Ähnliches.
    ...
    signing-party - Diverse nützliche OpenPGP für Tools< für Keysigning-Partys1
    GPG Suite (GPG Tools) für die Nutzung Mac OS, wie z.B. Einbindung in Apple Mail

    1. https://de.wikipedia.org/wiki/Keysigning-Party

## Weiterführende Links zu GnuPG
